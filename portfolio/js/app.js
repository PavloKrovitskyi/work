    ...
    (() => {
        ...
        function customCursor(isShadowTrue) {
            ...
            if (wrapper && !isMobile.any()) {
                ...
                document.querySelector("hover-target");
                ...
                function mouseActions(e) {
                    if (e.type === "mouseout") cursor.style.opacity = 0; else if (e.type === "mousemove") {
                        ...
                        if (e.target.closest("input") || e.target.closest("button") || e.target.closest(".hover-target") || window.getComputedStyle(e.target).cursor !== "none" && window.getComputedStyle(e.target).cursor !== "default") cursor.classList.add("_hover"); else cursor.classList.remove("_hover");
        ...
        if (currentTheme) document.documentElement.classList.add(currentTheme); else document.documentElement.classList.add("dark");
        ...
        function textType(element) {
            ...
            if (element) textTypeElements.push(element); else textTypeElements = document.querySelectorAll(`[data-text-type]`);
        ...
        let callback = (entries, observer) => {
            entries.forEach((entry => {
                const targetElement = entry.target;
                if (entry.isIntersecting) if (!targetElement.classList.contains("typing")) textType(targetElement);
            }));
        };
        ...
        document.querySelectorAll(".select__option").forEach((function(element) {
